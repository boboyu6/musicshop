...
<tr>
	...
	<td width="400" align="left">
		<select name="book_kind">
			...
			<option value="200"
			<%if(book.getBook_kind().equals("200")) { %> selected<%} %>>자기계발</option>
			<option value="300"
			<%if(book.getBook_kind().equals("300")) { %> selected<%} %>>IT 모바일</option>
			<option value="400"
			<%if(book.getBook_kind().equals("400")) { %> selected<%} %>>여행</option>
			<option value="500"
			<%if(book.getBook_kind().equals("500")) { %> selected<%} %>>자연과학</option>
		</select>
	</td>
</tr>
<tr>
...
<tr>
	...
	<td width="400" align="left">
		<input type="text" size="20" maxlength="30" name="author" value="<%=book.getAuthor()%>">
	</td>
</tr>
<tr>
...
<%-- <% System.out.println("할인율 : " + book.getDiscount_rate()); %> --%>
<tr>
